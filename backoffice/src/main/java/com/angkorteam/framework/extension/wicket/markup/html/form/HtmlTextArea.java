...
import com.angkorteam.framework.extension.wicket.resource.CodeMirrorResourceReference;
...
public class HtmlTextArea extends TextArea<String> {
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        response.render(JavaScriptHeaderItem.forReference(CodeMirrorResourceReference.CSS_HINT_JAVASCRIPT));
        response.render(JavaScriptHeaderItem.forReference(CodeMirrorResourceReference.HTML_HINT_JAVASCRIPT));
        response.render(JavaScriptHeaderItem.forReference(CodeMirrorResourceReference.XML_JAVASCRIPT));
        response.render(JavaScriptHeaderItem.forReference(CodeMirrorResourceReference.SCRIPT_JAVASCRIPT));
        response.render(JavaScriptHeaderItem.forReference(CodeMirrorResourceReference.CSS_JAVASCRIPT));
        response.render(JavaScriptHeaderItem.forReference(CodeMirrorResourceReference.VB_JAVASCRIPT));
        response.render(JavaScriptHeaderItem.forReference(CodeMirrorResourceReference.HTML_JAVASCRIPT));
