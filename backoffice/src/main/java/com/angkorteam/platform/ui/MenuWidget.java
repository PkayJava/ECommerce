...
public class MenuWidget extends Panel {
    ...
    protected void onInitialize() {
        ...
        selectQuery.addWhere("menu_id = :menu_id", this.menuId);
        ...
        selectQuery = new SelectQuery("menu");
        selectQuery.addWhere("parent_menu_id = :parent_menu_id", this.menuId);
        ...
        for (Object item : items) {
            if (item instanceof PlatformMenu) {
                MenuWidget itemWidget = new MenuWidget(itemWidgets.newChildId(), ((PlatformMenu) item).getMenuId());
                itemWidgets.add(itemWidget);
            } else if (item instanceof PlatformMenuItem) {
                MenuItemWidget itemWidget = new MenuItemWidget(itemWidgets.newChildId(), ((PlatformMenuItem) item).getMenuItemId());
                itemWidgets.add(itemWidget);
            }
        }
