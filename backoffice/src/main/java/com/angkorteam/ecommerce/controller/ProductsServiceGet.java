...
//        LOGGER.info("api : {}", ProductsServiceGet.class.getName());
...
//        colorQuery.addField("max(CONCAT('" + asset + "', '/api/resource', file.path, '/', file.name)) AS img");
//        if (!Strings.isNullOrEmpty(category)) {
...
//        colorQuery.addJoin(JoinType.LeftJoin, "file", "ecommerce_color.img_file_id = file.file_id");
...
//        }
//
//        PaginationVO<ProductVO> responseBody = new PaginationVO<>();
//        responseBody.setMetadata(new MetadataVO());
//        responseBody.getMetadata().setFilters(Lists.newArrayList());
//        PriceFilterVO priceFilter = new PriceFilterVO();
//        responseBody.getMetadata().getFilters().add(priceFilter);
//        BrandFilterVO brandFilter = new BrandFilterVO();
//        responseBody.getMetadata().getFilters().add(brandFilter);
//        ColorFilterVO colorFilter = new ColorFilterVO();
//        responseBody.getMetadata().getFilters().add(colorFilter);
//        SizeFilterVO sizeFilter = new SizeFilterVO();
//        responseBody.getMetadata().getFilters().add(sizeFilter);
//
...
//
//        List<BrandValueVO> brands = named.queryForList(brandQuery.toSQL(), brandQuery.getParam(), BrandValueVO.class);
//        if (brands != null && !brands.isEmpty()) {
//            brandFilter.getValues().addAll(brands);
//        }
//
//        List<ColorValueVO> colors = named.queryForList(colorQuery.toSQL(), colorQuery.getParam(), ColorValueVO.class);
//        if (colors != null && !colors.isEmpty()) {
//            colorFilter.getValues().addAll(colors);
//        }
//
//        List<SizeValueVO> sizes = named.queryForList(sizeQuery.toSQL(), sizeQuery.getParam(), SizeValueVO.class);
...
//                selectQuery.addWhere("ecommerce_size_id = ?", size);
...
//            selectQuery.addWhere("ecommerce_brand_id = ?", brand);
//            Map<String, Object> brandRecord = named.queryForMap(selectQuery.toSQL(), selectQuery.getParam());
//            productQuery.addWhere("ecommerce_brand.name = ?", brandRecord.get("name"));
//        }
//
...
//        responseBody.getMetadata().setRecordsCount(total);
//
...
//        }
//
//        responseBody.getMetadata().setLinks(Platform.buildLinks(request, total, limit));
//
//        productQuery.setLimit((page - 1) * limit, limit);
//
//        List<ProductVO> products = named.queryForList(productQuery.toSQL(), productQuery.getParam(), ProductVO.class);
...
//                }
//            }
//            responseBody.setRecords(products);
//        } else {
//            responseBody.setRecords(Lists.newArrayList());
//        }
//
