...
- Options: the list of objects to display.
  Each object must have a property with an unique **values** to identify the option; the property name is defined by the `valueField` setting.
...
<table width="100%">
	...
	<tr>
		...
		<td valign="top">If true, Selectize will treat any options with a "" values like normal. This defaults to false to accomodate the common &lt;select&gt; practice of having the first empty option to act as a placeholder.</td>
		<td valign="top"><code>boolean</code></td>
		<td valign="top"><code>false</code></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td valign="top">The name of the property to use as the <code>values</code> when an item is selected.</td>
		<td valign="top"><code>string</code></td>
	...
	<tr>
		<td valign="top"><code>onChange(values)</code></td>
		<td valign="top">Invoked when the values of the control changes.</td>
		<td valign="top"><code>function</code></td>
		<td valign="top"><code>null</code></td>
	</tr>
	<tr>
		<td valign="top"><code>onItemAdd(values, $item)</code></td>
		<td valign="top">Invoked when an item is selected.</td>
		<td valign="top"><code>function</code></td>
		<td valign="top"><code>null</code></td>
	</tr>
	<tr>
		<td valign="top"><code>onItemRemove(values)</code></td>
	...
	<tr>
		<td valign="top"><code>onOptionAdd(values, data)</code></td>
		<td valign="top">Invoked when a new option is added to the available options list.</td>
		<td valign="top"><code>function</code></td>
		<td valign="top"><code>null</code></td>
	</tr>
	<tr>
		<td valign="top"><code>onOptionRemove(values)</code></td>
