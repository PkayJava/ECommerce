...
<table width="100%">
	...
	<tr>
		...
		<td valign="top">An object containing the entire pool of options. The object is keyed by each object's values.</td>
	</tr>
	<tr>
...
<table width="100%">
	...
	<tr>
		<td valign="top"><code>updateOption(values, data)</code></td>
	...
	<tr>
		<td valign="top"><code>removeOption(values)</code></td>
		<td valign="top">Removes the option identified by the given values.</td>
	</tr>
	<tr>
	...
	<tr>
		<td valign="top"><code>getOption(values)</code></td>
		<td valign="top">Retrieves the jQuery element for the option identified by the given values.</td>
	</tr>
	<tr>
		<td valign="top"><code>getAdjacentOption(values, direction)</code></td>
	...
	<tr>
		<td valign="top"><code>getItem(values)</code></td>
		<td valign="top">Returns the jQuery element of the item matching the given values.</td>
	</tr>
	<tr>
		<td valign="top"><code>addItem(values, silent)</code></td>
	...
	<tr>
		<td valign="top"><code>removeItem(values, silent)</code></td>
		<td valign="top">Removes the selected item matching the provided values. If <code>silent</code> is truthy, no change event will be fired on the original input.</td>
	</tr>
	<tr>
		<td valign="top"><code>createItem(values, [triggerDropdown], [callback])</code></td>
	...
	<tr>
		...
		<td valign="top">Registers a new optgroup for options to be bucketed into. The <code>id</code> argument refers to a values of the property in option identified by the <code>optgroupField</code> setting.</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td valign="top">Returns the values of the control. If multiple items can be selected with a "select" input tag (e.g. <a href="usage.md#maxItems">&lt;select multiple&gt;</a>), this returns an array. Otherwise, returns a string (separated by <code>delimiter</code> if "multiple").</td>
	</tr>
	<tr>
		<td valign="top"><code>setValue(values, silent)</code></td>
		<td valign="top">Resets the selected items to the given values.</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td valign="top">When the `settings.placeholder` values is changed, the new placeholder will be displayed.</td>
